...
{
    public partial class frmDangNhapTrong : Form
    {
        public frmDangNhapTrong()
        {
            InitializeComponent();
        }
        ...
        private void btnDangNhap_Click(object sender, EventArgs e)
        {
            ...
            string strNguoiDung = "Select * From Nguoi_Dung Where UserName='" + txtTenNguoiDung.Text.Trim() + "' And PassWord='" + c.MaHoa(txtMatKhau.Text.Trim()) + "'";
