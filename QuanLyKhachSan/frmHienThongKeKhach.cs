...
{
    public partial class frmHienThongKeKhach : Form
    {
        public frmHienThongKeKhach()
        {
            InitializeComponent();
        }
        ...
        private void btnDongY_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            frmThongKeKhachHang fThongKeKhach = new frmThongKeKhachHang();
            fThongKeKhach.ShowDialog();
            this.Close();
        }
    }
}
