...
{
    public partial class frmBaoCaoDoanhThuPhong : Form
    {
        public frmBaoCaoDoanhThuPhong()
        {
            InitializeComponent();
        }

        private void frmBaoCaoDoanhThuPhong_Load(object sender, EventArgs e)
        {
            try
            {
                ReportDocument aa = new ReportDocument();
                aa.Load(Application.StartupPath + "\\crtDoanhThuPhong.rpt");
                //crtDoanhThuPhong aa = new crtDoanhThuPhong();
